...
from utils.market import get_futures_ohlcv
...
class TestGetFuturesOhlcv:
    ...
    def test_prices_are_decimal(self):
        ...
        candle = get_futures_ohlcv(client, "BTCUSDT", "1h")[0]
    ...
    def test_raises_on_invalid_symbol(self):
        ...
        with pytest.raises(BinanceAPIException):
            get_futures_ohlcv(client, "INVALIDSYMBOL", "1h")
